...
namespace Emboard
{
    ...
    {
        string[] file = { @"\Storage Card\Database\Xml\database.xml", @"\Storage Card\Database\Xml\baochay_db.xml" };
        ...
        * ****************************************************************************/
        ...
        public void setSensor_bc(string mac_sensor, string network_ip_sensor, bool status_sensor)
        {
            try
            {
                int total_sensor_bc = Convert.ToInt32(sensor_bc.Attributes[0].Value);
        ...
        // Lay trang thai 1 node sensor
        public string getStatusSensorBC(string mac)
        {
            try
            {
                XmlElement element = xml_bc.DocumentElement;
        ...
        // lay doa do pixel X node sensor
        public float getSensorBCPixel_x(string mac)
        {
            try
            {
                XmlElement element = xml_bc.DocumentElement;
        ...
        // lay toa do pixel Y node sensor
        public float getSensorBCPixel_y(string mac)
        {
            try
            {
                XmlElement element = xml_bc.DocumentElement;
        ...
        public void updateSensorBC(string mac, string ip, float temp, float humi, float energySensor, string time)
        {
            try
            {
                XmlElement element = xml_bc.DocumentElement;
