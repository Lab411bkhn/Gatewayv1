    ...
    class libDraw
    {
        ...
        public libDraw()
        {
            ...
            catch
            {
                try
                {
                    path_icon_sensor_true = @"\Storage Card\Database\Icon\red.png";
                    path_icon_sensor_false = @"\Storage Card\Database\Icon\violet.png";
                    path_icon_actor_true = @"\Storage Card\Database\Icon\blue.png";
                    path_icon_actor_false = @"\Storage Card\Database\Icon\violet.png";
                    path_icon_val_on = @"\Storage Card\Database\Icon\yellow.png";
                    path_icon_val_off = @"\Storage Card\Database\Icon\grey.png";
                    path = @"\Storage Card\Database\Icon\bando.png";
                }
                catch
                {
